...
public class DeployController {
	...
	@Autowired
	private WAHServices wahServices;
	
	@RequestMapping(value="/start", method=RequestMethod.GET)
    public Long start() {
    	//String processId = "com.cts.user_task_training";
		String processId = "client-business-application-kjar.SpringBoot";
    	Map<String, Object> params = new HashMap<>();
    	//params.put("test", "test");
    	long pid = wahServices.startProcess(processId, params);
